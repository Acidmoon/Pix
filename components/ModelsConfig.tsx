    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <Field label={t("modelsconfig.apiKey")}>
        ...
        <span style={{ fontSize: 10, color: "var(--text-dim)", marginTop: 2 }}>
          {t("modelsconfig.apiKeyHintPrefix")}<code style={{ fontFamily: "var(--font-mono)" }}>!</code>{t("modelsconfig.apiKeyHintSuffix")}
        </span>
      </Field>
        ...
        return (
          ...
          >
            ...
            <div style={{ display: "flex", borderRadius: 5, border: "1px solid var(--border)", overflow: "hidden", flexShrink: 0 }}>
              ...
              >
                {t("modelsconfig.thinkingLevelDefault")}
              </button>
              <button
            ...
            <div style={{ display: "flex", borderRadius: 5, border: `1px solid ${state === "string" ? "var(--accent)" : "var(--border)"}`, overflow: "hidden", transition: "border-color 0.1s" }}>
              ...
              >
                {t("modelsconfig.thinkingLevelCustom")}
              </button>
              <input
                value={strVal}
...
function ModelDetail({
  ...
  const testSummary = (() => {
    ...
    if (testState.phase === "testing") return t("modelsconfig.testConnecting");
    const meta = [
      testState.latencyMs !== undefined ? `${testState.latencyMs}ms` : null,
      testState.status !== undefined ? `HTTP ${testState.status}` : null,
    ].filter(Boolean);
    if (testState.phase === "success") {
      return [t("modelsconfig.testConnected"), ...meta, testState.responseText || null].filter(Boolean).join(" · ");
    }
    return [t("modelsconfig.testFailed"), ...meta, testState.message].filter(Boolean).join(" · ");
  })();
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <button
            ...
            title={t("modelsconfig.testConnectionTitle")}
            style={{
              height: 24,
              padding: "0 8px",
          ...
          >
            ...
            {testState.phase === "testing" ? t("modelsconfig.testRunning") : testState.phase === "success" ? t("modelsconfig.testPassed") : t("modelsconfig.testRun")}
          </button>
          <button onClick={onDelete}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
        ...
        <Field label={t("modelsconfig.modelName")}><TextInput value={model.name ?? ""} onChange={(v) => set("name", v || undefined)} placeholder={t("modelsconfig.displayNamePlaceholder")} /></Field>
      </div>
      ...
      <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
        <Check label={t("modelsconfig.reasoning")} checked={model.reasoning ?? false} onChange={(v) => set("reasoning", v || undefined)} />
      ...
      {model.reasoning && (
        <>
          <Check
            label={t("modelsconfig.deepseekCompat")}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
        <Field label={t("modelsconfig.contextWindow")}>
      ...
      <div>
        <SectionTitle>{t("modelsconfig.costTitle")}</SectionTitle>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ minHeight: 48 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <p style={{ margin: 0, fontSize: 12, color: "var(--text-muted)", lineHeight: 1.5 }}>
              {loginState.phase === "auth"
                ? t("modelsconfig.authInstructions")
                : loginState.message}
            </p>
            {loginState.phase === "auth" && (
              <p style={{ margin: 0, fontSize: 11, color: "var(--text-dim)", lineHeight: 1.5 }}>
                {t("modelsconfig.browserNotOpen")}{" "}
                <a href={loginState.url} target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent)", wordBreak: "break-all" }}>
                  {t("modelsconfig.clickToOpenLogin")}
                </a>
                {t("modelsconfig.browserNotOpenSuffix")}
              </p>
            )}
        ...
        {loginState.phase === "device_code" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <p style={{ margin: 0, fontSize: 12, color: "var(--text-muted)", lineHeight: 1.5 }}>
              {t("modelsconfig.deviceCodePrompt")}
            </p>
            ...
            <p style={{ margin: 0, fontSize: 11, color: "var(--text-dim)", lineHeight: 1.5 }}>
              ...
              {loginState.expiresInSeconds ? t("modelsconfig.expiresIn", { minutes: Math.ceil(loginState.expiresInSeconds / 60) }) : ""}
            </p>
          </div>
        )}
        ...
        {loginState.phase === "success" && (
          <p style={{ margin: 0, fontSize: 12, color: "#4ade80" }}>{t("modelsconfig.connectedSuccess")}</p>
        )}
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <p style={{ margin: 0, fontSize: 12, color: "var(--text-muted)", lineHeight: 1.5 }}>
        {provider.configured
          ...
          : t("modelsconfig.enterApiKey", { name: provider.displayName, count: provider.modelCount })}
      </p>
      ...
      <Field label={t("modelsconfig.apiKey")}>
        <div style={{ display: "flex", gap: 6 }}>
          <SecretTextInput
            ...
            placeholder={provider.configured ? t("modelsconfig.replaceKeyPlaceholder") : "sk-…"}
            style={{ flex: 1 }}
            autoComplete="off"
            spellCheck={false}
            mono
          ...
          >
            ...
            {savedOk ? t("modelsconfig.saved") : saving ? t("modelsconfig.saving") : t("general.save")}
          </button>
        </div>
      </Field>
          ...
          {totalCount === 0 ? (
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(240px, 100%), 1fr))", gap: 8 }}>
              ...
              {showCustom && (
                ...
                >
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: 12, fontWeight: 600, color: "var(--text)", lineHeight: 1.3, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{t("modelsconfig.customCompatTitle")}</div>
                    <div style={{ fontSize: 10, color: "var(--text-dim)", marginTop: 2 }}>{t("modelsconfig.customCompatDesc")}</div>
                  </div>
              ...
              {availableOAuth.length > 0 && (
                <div style={{ gridColumn: "1 / -1", paddingTop: showCustom ? 6 : 0, fontSize: 10, fontWeight: 600, color: "var(--text-dim)", textTransform: "uppercase", letterSpacing: "0.07em" }}>{t("modelsconfig.subscriptionsSection")}</div>
              )}
              ...
              {availableApiKey.map((p) => (
                ...
                >
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: 10, color: "var(--text-dim)", marginTop: 2 }}>{t("modelsconfig.modelCount", { count: p.modelCount })}</div>
                  </div>
                  <ProviderIcon id={p.id} size={28} />
                </button>
              ))}
      ...
      <div style={{ width: isMobile ? "calc(100vw - 16px)" : 860, maxWidth: "calc(100vw - 16px)", height: isMobile ? "calc(100dvh - 16px)" : "78vh", maxHeight: "calc(100dvh - 16px)", background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 10, display: "flex", flexDirection: "column", boxShadow: "0 8px 32px rgba(0,0,0,0.18)", overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: isMobile ? "column" : "row", overflow: "hidden" }}>
          ...
          <div style={{
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: "8px 6px" }}>
              ...
              {/* Custom providers */}
              {loading ? (
                <div style={{ padding: "10px 8px", fontSize: 12, color: "var(--text-muted)" }}>{t("general.loading")}</div>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 10, padding: "10px 18px", borderTop: "1px solid var(--border)", flexShrink: 0 }}>
          ...
          <button onClick={handleSave} disabled={saving || savedOk} style={{
            ...
            <span>{savedOk ? t("modelsconfig.saved") : saving ? t("modelsconfig.saving") : t("general.save")}</span>
          </button>
        </div>
      </div>
    </div>
