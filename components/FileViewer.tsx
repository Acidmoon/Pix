  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
      ...
      >
        ...
        <span style={{ marginLeft: "auto" }}>{ext || t("fileviewer.imageLabel")}</span>
      ...
      >
        {error ? (
          ...
          <img
            ...
            onError={() => setError(t("fileviewer.loadImageFailed"))}
            style={{
              maxWidth: "100%",
              maxHeight: "100%",
              objectFit: "contain",
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
      ...
      >
        ...
        <span style={{ marginLeft: "auto" }}>{ext || t("fileviewer.audioLabel")}</span>
      ...
      >
        <div style={{ width: "min(680px, 100%)" }}>
          ...
          <audio
            ...
            onError={() => setError(t("fileviewer.loadAudioFailed"))}
            style={{ width: "100%" }}
          />
        </div>
      </div>
              ...
              {displayModes.map((mode) => {
                ...
                return (
                  <button
                    ...
                    title={mode === "diff" ? t("fileviewer.diffTitle") : undefined}
                    aria-pressed={active}
            ...
            {effectiveDisplayMode === "source" && (
              <>
                <button
                  ...
                  title={t("fileviewer.mentionLines")}
                  aria-label={t("fileviewer.mentionLines")}
                ...
                <button
                  ...
                  title={wrapLines ? t("fileviewer.disableWrap") : t("fileviewer.enableWrap")}
                  aria-label={wrapLines ? t("fileviewer.disableWrap") : t("fileviewer.enableWrap")}
